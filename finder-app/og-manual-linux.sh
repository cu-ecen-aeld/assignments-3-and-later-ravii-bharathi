...
sudo cp -a $SYSROOT/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64/ 2>/dev/null || true
...
sudo cp -r /home/ravi/repos/aeld-assignments/conf/* ${OUTDIR}/rootfs/home/
sudo cp -r  /home/ravi/repos/aeld-assignments/finder-app/* ${OUTDIR}/rootfs/home/
sudo cp -r /home/ravi/repos/aeld-assignments/autorun-qemu.sh ${OUTDIR}/rootfs/home/

echo "listing directory with permisions"
